...
using Cockroaches.Repository.Infrastructure.Contract;
using Cockroaches.Model;
using System.Data.Entity.Core.Objects;
using System.Linq.Expressions;

namespace Cockroaches.Repository.Infrastructure
{
    /// <summary>
        ...
        where T : class
    {
        ...
        protected CockroachesEntities _entities;
        protected readonly IDbSet<T> _dbset;
        public BaseRepository()
        {
            _entities = new CockroachesEntities();
