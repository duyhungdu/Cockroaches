...
namespace Cockroaches.API.Providers
{
    /// <summary>
    /// OAuth
    /// </summary>
    public class ApplicationOAuthProvider : OAuthAuthorizationServerProvider
    {
        ...
        public override async Task GrantResourceOwnerCredentials(OAuthGrantResourceOwnerCredentialsContext context)
        {
            ...
            else if (user != null)
            {
                ...
                //Cockroaches.Model.UserDepartment userInfo = new Model.UserDepartment();
                //Cockroaches.Repository.DepartmentRepository departmentRepository = new Repository.DepartmentRepository();
                ...
                var properties = new AuthenticationProperties(new Dictionary<string, string>
                    {
                        ...
                        {"googleAccount", user.GoogleAccount != null ? user.GoogleAccount.ToString() : string.Empty}
                    });
